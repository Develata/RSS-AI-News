# RSS-AI-News 文档总览（已归档 · 观察期 · 只读）

> **观察期通知**（2026-06-04 添加）：本目录是 v0.3.x / W11 建造期文档的**冻结备份**，
> 已于 Phase A–C docs/ 重整后从 `docs/` 移入 `docs-backup/`。新工作 **不再写入** 本目录。
>
> 当前阶段：**观察期**。在 v0.4+ release 前评审是否仍有未被新 `../docs/` 覆盖的内容；
> 评审通过后，本目录将被**单独 commit 删除**。
>
> 新文档真相源：[../docs/](../docs/)（plan / acceptance-cases / map / operations / adr / reports）。

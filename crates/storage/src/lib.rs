...
pub use repo::{
    ...
    ClaimedReindexJob, ConfigRotation, ContentHashReindexCandidate, FeedEntry, FeedEntryRepo,
    FeedEntryRepository, FeedSourceRepo, FeedSourceRepository, FinishReindexTxOutcome,

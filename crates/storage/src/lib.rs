...
pub use pool::{StoragePool, build_sqlite_pool};
pub use repo::{
    ...
    FeedEntry, FeedEntryRepository, FeedSourceRepository, FinishReindexTxOutcome,
    FreezeSnapshotItem, FreezeSnapshotOutcome, FreezeSnapshotStatus, InsertPendingOutcome,
    LeaseGuardedWriteOutcome, LinkHashReindexCandidate, NewAiResult, NewArticle, NewFeedEntry,
    NewPublishRecord, NewRawArtifact, NewRunEvent, PublishAdvanceExtras, PublishCandidateRow,
    PublishItemRepository, PublishRecord, PublishRecordRepository, PublishState,
    PublishTimestampField, RawArtifactRepository, ReindexJob, ReindexJobRepository,
    ReleaseSuccessOutcome, ResetFailedFilter, ResetFailedOutcome, RuleVersion,
    ...
    SqliteRawArtifactRepo, SqliteReindexJobRepo, SqliteRuleVersionRepo, SqliteRunEventRepo,
